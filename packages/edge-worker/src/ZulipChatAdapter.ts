 ...
 * address it (an @mention or a DM), so every event Miko sees is directed at
	...
	implements ChatPlatformAdapter<ZulipWebhookEvent>
{
	...
	/**
	 * What was said in this topic since Miko last had context.
	 *
	 ...
	 * Miko's own past replies included.
	 *
